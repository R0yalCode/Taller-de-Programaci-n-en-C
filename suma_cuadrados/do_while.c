// Suma de los cuadrados de los primeros n números con Do While
#include <stdio.h>
...
int main() {
    ...
    // Se utiliza el bucle do while para calcular la suma de los cuadrados de los primeros n números
    do {
